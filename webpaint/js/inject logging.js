...
window.TextCursor ||
    ...
    (window.TextLine.prototype = {
      ...
      draw: function (t) {
        t.save(),
          ...
          (t.lineWidth = 1),
          t.strokeText(this.text, this.left, this.bottom),
          t.fillText(this.text, this.left, this.bottom),
          t.restore();
      },
      erase: function (t) {
        window.NOTEPAD.restoreCanvas();
  ...
  window.Paragraph ||
    ((window.Paragraph = function (t, e, i, n, s) {
      (this.context = t),
        (this.drawingSurface = n),
        (this.left = e),
        (this.top = i),
        (this.lines = []),
        (this.activeLine = void 0),
        (this.cursor = s),
        (this.blinkingInterval = void 0);
    }),
    (window.Paragraph.prototype = {
      clearIntervals: function (t) {
        (this.blinkingInterval = window.clearInterval(this.blinkingInterval)),
          ...
          "function" != typeof t || this.blinkingInterval
            ? this.blinkingInterval && this.clearIntervals(t)
            : t();
      },
      isPointInside: function (t) {
        ...
        return (
          e.beginPath(),
          e.rect(this.left, this.top, this.getWidth(), this.getHeight()),
      ...
      insert: function (t) {
        ...
        var e = this.activeLine.text.substring(0, this.activeLine.caret),
          i = this.context.measureText(e).width;
        this.moveCursor(this.activeLine.left + i, this.activeLine.bottom),
      ...
      blinkCursor: function (t, e) {
        ...
        this.blinkingInterval &&
          ...
          (this.blinkingInterval = setInterval(function (t) {
            var e =
              window.NOTEPAD.drawOptions[window.NOTEPAD.selectedDrawOption];
            e && "text" === e.type
              ? (i.cursor.erase(i.context, i.drawingSurface),
                i.blinkingTimeout &&
                  (i.blinkingTimeout = window.clearTimeout(i.blinkingTimeout)),
                (i.blinkingTimeout = setTimeout(function (t) {
                  i.cursor.draw(
                    i.context,
                    i.cursor.left,
                    i.cursor.top + i.cursor.getHeight(i.context)
                  );
                }, 200)))
              : (i.blinkingInterval = window.clearInterval(i.blinkingInterval));
          }, 900));
      },
      ...
      newline: function () {
        var t,
          ...
          n = this.activeLine.text.substring(this.activeLine.caret),
          s =
            this.context.measureText("W").width +
            this.context.measureText("W").width / 6,
          o = this.activeLine.bottom + s;
        this.erase(this.context, this.drawingSurface),
          (this.activeLine.text = i),
          (e = new TextLine(this.activeLine.left, o)).insert(n),
          (t = this.lines.indexOf(this.activeLine)),
          this.lines.splice(t + 1, 0, e),
          (this.activeLine = e),
          (this.activeLine.caret = 0);
        for (
          var a = (t = this.lines.indexOf(this.activeLine)) + 1;
          a < this.lines.length;
          ++a
        )
          (e = this.lines[a]).bottom += s;
        this.draw(),
          this.cursor.draw(
            this.context,
            this.activeLine.left,
      ...
      getColumn: function (t, e) {
        var i,
          ...
          a = !1;
        for (
          (s = new TextLine(t.left, t.bottom)).insert(t.text);
          !a && 0 < s.text.length;

        )
          (i = s.left + s.getWidth(this.context)),
            s.removeLastCharacter(),
            (n = s.left + s.getWidth(this.context)) < e &&
              ((o =
                (e - n < i - e ? n : i) === i
                  ? s.text.length + 1
                  : s.text.length),
      ...
      moveUpOneLine: function () {
        ...
        (this.activeLine = this.lines[i - 1]),
        ...
        for (var n = i; n < this.lines.length; ++n)
        ...
        this.context.save(),
          0 === this.activeLine.caret
            ...
            : (this.erase(this.context, this.drawingSurface),
              ...
              (e = this.context.measureText(t).width),
              this.moveCursor(this.activeLine.left + e, this.activeLine.bottom),
              this.draw(this.context),
    ...
    if (
      (this.currentIndex < this.array.length - 1
        ? ((this.array[++this.currentIndex] = t),
          (this.array = this.array.slice(0, this.currentIndex + 1)))
        : (this.array.push(t), (this.currentIndex = this.array.length - 1)),
      this.array.length > this.MAX_ITEMS)
    ) {
      var e = this.array.length - this.MAX_ITEMS;
      (this.array = this.array.splice(-this.MAX_ITEMS)),
    ...
    e = {
      ...
      createCanvas: function () {
        console.log("inject.js e 내부 createCanvas"),
          (this.canvas = v.document.createElement("canvas")),
          (this.context = this.canvas.getContext("2d")),
          this.canvas.setAttribute("id", "NOTEPAD"),
          this.browser.isChrome ||
            (this.buffer = document.createElement("canvas")),
          v.document.body.appendChild(this.canvas),
          v.addEventListener("resize", this.resizeBinded),
          v.addEventListener("scroll", this.resizeBinded);
        var t = localStorage.getItem(
          "WP_CRX_STORAGE_SNAPSHOT_" + v.location.pathname
        );
        if (t) {
          var e = new Image();
          (e.onload = Function.prototype.bind.call(this.initCanvas, this, e)),
            (e.src = t);
      ...
      handleBackButtonClick: function () {
        console.log("inject.js e 내부 handleBackButtonClick");
        this.history.hasPrevious() &&
          (this.finishLastDrawing(),
          this.context.putImageData(this.history.previous(), 0, 0),
          this.storeCanvas(),
          this.checkHistoryButtonStatus());
      },
      handleForwardButtonClick: function () {
        console.log("inject.js e 내부 handleForwardButtonClick");
        this.history.hasNext() &&
          (this.finishLastDrawing(),
          this.context.putImageData(this.history.next(), 0, 0),
          this.storeCanvas(),
          this.checkHistoryButtonStatus());
      },
      persistLocalStorage: function () {
        console.log("inject.js e 내부 persistLocalStorage");
      ...
      storeCanvas: function (t) {
        console.log("inject.js e 내부 storeCanvas");
        this.browser.isChrome
          ...
          t ||
            (this.persistTimer &&
              (this.persistTimer = v.clearInterval(this.persistTimer)),
            (this.persistTimer = v.setTimeout(
              this.persistLocalStorageBinded,
              500
            )));
      },
      restoreCanvas: function (t) {
        console.log("inject.js e 내부 restoreCanvas");
        t
          ? (this.context.clearRect.apply(this.context, t),
            this.browser.isChrome
              ? (t.unshift(this.buffer, 0, 0),
                this.context.putImageData.apply(this.context, t))
        ...
        5e3 < i - this.canvas.offsetTop
          ...
          e
            ? (this.context.clearRect(
              ...
              this.paragraph &&
                (this.paragraph.clearIntervals(), (this.paragraph = null)),
              this.storeCanvas(!0))
            : this.storeCanvas(t),
          (this.canvas.width = s),
          (this.canvas.height = a),
          e || this.restoreCanvas(),
          this.updatePaintStyle(),
          (this.context.lineWidth = n);
      },
      createControlPanel: function () {
        console.log("inject.js e 내부 createControlPanel");
        (this.panel = v.document.createElement("div")),
          (this.backBtn = v.document.createElement("div")),
          (this.nextBtn = v.document.createElement("div"));
        var tools = v.document.createElement("div"),
          color = v.document.createElement("div"),
          controls = v.document.createElement("div"),
          transparency = v.document.createElement("div"),
          size_control = v.document.createElement("div");
        this.panel.setAttribute("id", "NOTEPAD_controls"),
          tools.setAttribute("class", "NOTEPAD_controls_draw"),
          color.setAttribute("class", "NOTEPAD_controls_color"),
          controls.setAttribute("class", "NOTEPAD_controls_control"),
          transparency.setAttribute(
            "class",
            "NOTEPAD_controls_range alpha_control"
          ),
          size_control.setAttribute(
            "class",
            "NOTEPAD_controls_range size_control"
          ),
          v.document.body.appendChild(this.panel),
        ...
        for (var o = 0; o < this.drawOptions.length; o++) {
          ...
          r.setAttribute("class", "NOTEPAD_controls_draw_option"),
        ...
        (this.colorPicker = v.document.createElement("input")),
          ...
          (this.alphaPicker = v.document.createElement("input")),
          ...
          (this.alphaPickerPreview = v.document.createElement("p")),
        ...
        h.setAttribute("type", "range"),
          ...
          (this.linePickerPreview = v.document.createElement("p")),
        ...
        c.setAttribute("class", "NOTEPAD_controls_control_option prtBtn"),
          ...
          this.backBtn.setAttribute(
            "class",
            "NOTEPAD_controls_control_option backBtn"
          ),
          this.backBtn.setAttribute("title", "Step backward"),
          this.nextBtn.setAttribute(
            "class",
            "NOTEPAD_controls_control_option nextBtn"
          ),
          this.nextBtn.setAttribute("title", "Step forward"),
          d.setAttribute(
            "class",
            "NOTEPAD_controls_control_option eraseAllBtn"
          ),
          d.setAttribute("title", "Erase all"),
          u.setAttribute(
            "class",
            "NOTEPAD_controls_control_option hideCtrlBtn"
          ),
          u.setAttribute(
            "title",
      ...
      finishLastDrawing: function () {
        console.log("inject.js e 내부 finishLastDrawing");
        var t = this.drawOptions[this.selectedDrawOption];
        t && "polygon" === t.type && t.lastLoc && t.initLoc
          ? (this.context.beginPath(),
            this.context.moveTo(t.lastLoc.x, t.lastLoc.y),
            this.context.lineTo(t.initLoc.x, t.initLoc.y),
            this.context.stroke(),
            ...
            this.storeCanvas(),
            this.storeHistory())
          : t && "quadratic_curve" === t.type && 0 !== t.iteration
          ? (this.context.closePath(),
            this.storeCanvas(),
            this.storeHistory(),
            (this.mousedown = !1),
            ...
            (t.initLoc = null),
            (t.lastLoc = null))
          : t && "bezier_curve" === t.type && 0 !== t.iteration
          ? (this.context.closePath(),
            this.storeCanvas(),
            this.storeHistory(),
            (this.mousedown = !1),
          ...
          : "eyedropper" !== t &&
            !0 === this.mousedown &&
            ((this.mousedown = !1), this.storeCanvas(), this.storeHistory()),
          this.paragraph &&
      ...
      setColor: function (t) {
        console.log("inject.js e 내부 setColor");
        t &&
          ((this.colorPicker.value = this.rgbToHex(t.r, t.g, t.b)),
          (this.selectedColorOption = {
            r: t.r,
            g: t.g,
            b: t.b,
          }),
          (this.alphaPicker.value = t.a / 255),
          (this.selectedAlphaOption = this.alphaPicker.value),
          this.alphaPickerPreview &&
            (this.alphaPickerPreview.innerHTML =
              Math.round(100 * this.selectedAlphaOption) + "%"),
          this.updatePaintStyle(),
          (this.config.color === this.colorPicker.value &&
            this.config.alpha === this.selectedAlphaOption) ||
            ((this.config.color = this.colorPicker.value),
            (this.config.alpha = this.selectedAlphaOption),
            this.saveData()));
      },
      getColorOfCurrentPixel: function (t) {
        console.log("inject.js e 내부 getColorOfCurrentPixel");
        g.runtime.sendMessage(
          {
      ...
      onPrintButtonClick: function () {
        console.log("inject.js e 내부 onPrintButtonClick");
      ...
      onControlPanelClick: function (t, e) {
        ...
        if (this.selectedDrawOption !== t) {
          ...
          this.addClass(i[t], "selected"),
            ...
            this.removeClass(this.canvas, "eyedropper"),
            this.removeClass(this.canvas, "fill"),
            (this.selectedDrawOption = t);
          ...
          "pen" === s.type
            ...
            : "eyedropper" === s.type
            ? this.addClass(this.canvas, "eyedropper")
            : "fill" === s.type
            ? this.addClass(this.canvas, "fill")
            : this.addClass(this.canvas, "cross"),
            this.config.tool !== this.selectedDrawOption &&
              ((this.config.tool = this.selectedDrawOption), this.saveData());
        }
      },
      hexToRgb: function (t) {
        console.log("inject.js e 내부 hexToRgb");
      ...
      rgbToHex: function (t, e, i) {
        console.log("inject.js e 내부 rgbToHex");
        return (
          "#" + ((1 << 24) + (t << 16) + (e << 8) + i).toString(16).slice(1)
        );
      },
      onColorPanelClick: function (t) {
        console.log("inject.js e 내부 onColorPanelClick");
        (this.selectedColorOption = this.hexToRgb(t.currentTarget.value)),
          this.updatePaintStyle(),
          this.config.color !== t.currentTarget.value &&
            ((this.config.color = t.currentTarget.value), this.saveData());
      },
      onAlphaChange: function (t) {
        console.log("inject.js e 내부 onAlphaChange");
        (this.selectedAlphaOption = t.currentTarget.value),
          this.alphaPickerPreview &&
            (this.alphaPickerPreview.innerHTML =
              Math.round(100 * this.selectedAlphaOption) + "%"),
          this.updatePaintStyle(),
      ...
      onAlphaUpdate: function (t) {
        ...
        this.alphaPickerPreview &&
          (this.alphaPickerPreview.innerHTML =
            Math.round(100 * t.currentTarget.value) + "%");
      },
      onLineChange: function (t) {
        console.log("inject.js e 내부 onLineChange");
        (this.context.lineWidth = t.currentTarget.value),
          this.linePickerPreview &&
            (this.linePickerPreview.innerHTML =
              Math.round((this.context.lineWidth / 20) * 100) + "%"),
          this.config.thickness !== this.context.lineWidth &&
            ((this.config.thickness = this.context.lineWidth), this.saveData());
      },
      ...
      updatePaintStyle: function () {
        ...
        null !== this.selectedColorOption &&
          ...
          ((this.cursor.fillStyle =
            "rgba(" +
            this.selectedColorOption.r +
            "," +
            this.selectedColorOption.g +
            "," +
            this.selectedColorOption.b +
            "," +
            this.selectedAlphaOption +
            ")"),
      ...
      addMouseEventListener: function () {
        ...
        var t = Function.prototype.bind.call(this.handleMouseDown, this),
          e = Function.prototype.bind.call(this.handleMouseMove, this),
          i = Function.prototype.bind.call(this.handleMouseUp, this),
          n = Function.prototype.bind.call(this.handleMouseLeave, this);
        this.canvas.addEventListener("mousedown", t),
          ...
          v.document.addEventListener("keydown", this.keydownBinded),
          v.document.addEventListener("keypress", this.keypressBinded);
      },
      addKeyEventListeners: function () {
        console.log("inject.js e 내부 addKeyEventListeners");
        this.config.hotkeys &&
          v.document.addEventListener("keydown", this.handleHotKeysDownBinded);
      },
      handleHotKeysDown: function (t) {
        console.log("inject.js e 내부 handleHotKeysDown");
        var e = v.event ? event : t;
        if (e.ctrlKey && e.shiftKey)
          for (var i in this.config.hotkeys)
            if (
              this.config.hotkeys.hasOwnProperty(i) &&
              this.config.hotkeys[i].charCodeAt(0) === e.keyCode
            ) {
              for (var n = 0; n < this.drawOptions.length; n++)
                if (this.drawOptions[n].type === i) {
      ...
      handleFill: function (t) {
        ...
        var e = this.context.getImageData(
          ...
          i = 4 * (t.y * this.canvas.width + t.x),
          n = e.data[i],
          s = e.data[i + 1],
          o = e.data[i + 2],
          a = e.data[i + 3],
          r = this.selectedColorOption.r,
          h = this.selectedColorOption.g,
          c = this.selectedColorOption.b,
          l = Math.round(255 * this.selectedAlphaOption);
        (n === r && s === h && o === c && a === l) ||
          this.matchOutlineColor(n, s, o, a) ||
          (this.floodFill(
            t.x,
            t.y,
            [
              ...
              this.selectedColorOption.g,
              this.selectedColorOption.b,
              Math.round(255 * this.selectedAlphaOption),
            ],
            !1,
            e,
            0,
      ...
      floodFill: function (t, e, o, i, n, a, s) {
        ...
        for (d.push([y, m]); d.length; ) {
          ...
          for (
            T = !1,
              i &&
                (!D(y - 1, m) && D(y - 1, m - 1) && d.push([y - 1, m - 1]),
                !D(y + 1, m) && D(y + 1, m - 1) && d.push([y + 1, m - 1])),
              p = u = !1;
            D(y, m);
            ...
            void 0,
              ...
              (l[c + 3] = o[3]),
              (f[h * v + r] = 255),
              D(y - 1, m) ? u || (d.push([y - 1, m]), (u = !0)) : u && (u = !1),
              D(y + 1, m) ? p || (d.push([y + 1, m]), (p = !0)) : p && (p = !1),
              (m += 1);
          i &&
            (D(y - 1, m) && !u && d.push([y - 1, m]),
            D(y + 1, m) && !p && d.push([y + 1, m]));
        }
      },
      handleKeyDown: function (t) {
        console.log("inject.js e 내부 handleKeyDown");
        this.paragraph &&
          ((8 !== t.keyCode && 13 !== t.keyCode) || t.preventDefault(),
          8 === t.keyCode
            ? this.paragraph.backspace()
            : 13 === t.keyCode && this.paragraph.newline());
      },
      handleKeyPress: function (t) {
        console.log("inject.js e 내부 handleKeyPress");
        if (this.paragraph) {
          ...
          if (8 !== t.keyCode && !t.ctrlKey && !t.metaKey) {
            ...
            (this.context.font =
              i.minSize +
              ((i.maxSize - i.minSize) * this.context.lineWidth) / 20 +
              "px " +
              i.font),
      ...
      handleMouseDown: function (t) {
        console.log("inject.js e 내부 handleMouseDown");
        ...
        if (
        ...
        else if ("eyedropper" === e.type)
          this.getColorOfCurrentPixel({
            x: Math.round(
              v.devicePixelRatio *
                (void 0 === t.clientX ? t.touches[0].clientX : t.clientX - 2)
            ),
            y: Math.round(
              v.devicePixelRatio *
                (void 0 === t.clientY ? t.touches[0].clientY : t.clientY + 22)
            ),
          });
        else if ("line" === e.type) this.storeCanvas();
        else if ("quadratic_curve" === e.type) {
          if (0 === e.iteration)
            this.storeCanvas(),
              (e.initLoc = {
          ...
          else if (1 === e.iteration);
          else if (2 !== e.iteration) throw new Error("invalid iteration");
        } else if ("polygon" === e.type)
          this.storeCanvas(),
            e.lastLoc
              ? (this.context.beginPath(),
                this.context.moveTo(e.lastLoc.x, e.lastLoc.y),
                this.context.lineTo(
                  this.lastMouseDownLoc.x,
        ...
        else if ("circle" === e.type) this.storeCanvas();
        else if ("rectangle" === e.type) this.storeCanvas();
        else if ("eraser" === e.type)
          this.restoreCanvas(),
            this.context.save(),
            ...
            this.context.restore();
        else if ("fill" === e.type) this.handleFill(this.lastMouseDownLoc);
        else if ("text" === e.type)
          if (
            (this.cursor.erase(this.context, this.drawingSurfaceImageData),
            this.storeCanvas(),
            this.paragraph &&
              this.paragraph.isPointInside(this.lastMouseDownLoc))
          )
            this.paragraph.moveCursorCloseTo(
              this.lastMouseDownLoc.x,
              this.lastMouseDownLoc.y
            );
          else {
            ...
            (i += i / 6),
              (this.paragraph = new Paragraph(
                this.context,
                this.lastMouseDownLoc.x,
                this.lastMouseDownLoc.y - i,
                this.drawingSurfaceImageData,
                this.cursor
              )),
              this.paragraph.addLine(
                new TextLine(this.lastMouseDownLoc.x, this.lastMouseDownLoc.y)
              );
          }
      },
      handleMouseMove: function (t) {
        ...
        this.setLineProperty(),
          this.mousedown ||
            ...
            (this.restoreCanvas(),
            this.context.save(),
            this.context.translate(i.x, i.y),
            this.context.clearRect(0, 0, e.width, e.height),
            this.context.restore()),
          "quadratic_curve" === e.type
            ? 1 === e.iteration &&
              e.lastLoc &&
              (this.restoreCanvas(),
              this.context.beginPath(),
              this.context.moveTo(e.initLoc.x, e.initLoc.y),
              this.context.quadraticCurveTo(i.x, i.y, e.lastLoc.x, e.lastLoc.y),
              this.context.stroke())
            : "bezier_curve" === e.type &&
              (1 === e.iteration && e.firstPoint
                ? (this.restoreCanvas(),
                  this.context.beginPath(),
                  this.context.moveTo(e.initLoc.x, e.initLoc.y),
          ...
          this.mousedown &&
            ("pen" === e.type
              ...
              ? (this.restoreCanvas(),
                ...
                this.context.lineTo(i.x, i.y),
                this.context.stroke())
              : "bezier_curve" === e.type && 0 === e.iteration
              ? (this.restoreCanvas(),
                this.context.beginPath(),
                this.context.moveTo(
                  this.lastMouseDownLoc.x,
              ...
              ? (this.restoreCanvas(),
                ...
                this.context.lineTo(this.lastMouseDownLoc.x, i.y),
                this.context.lineTo(i.x, i.y),
                this.context.lineTo(i.x, this.lastMouseDownLoc.y),
                this.context.lineTo(
                  this.lastMouseDownLoc.x,
                  this.lastMouseDownLoc.y
                ),
      ...
      handleMouseUp: function (t) {
        console.log("inject.js e 내부 handleMouseUp");
        t.preventDefault(), (this.mousedown = !1);
        var e = this.drawOptions[this.selectedDrawOption],
          i = this.windowToCanvas(
            void 0 === t.clientX ? t.changedTouches[0].clientX : t.clientX,
            void 0 === t.clientY ? t.changedTouches[0].clientY : t.clientY
          );
        "pen" === e.type
          ? (this.context.closePath(), this.storeCanvas(), this.storeHistory())
          : "line" === e.type
          ? (this.context.closePath(), this.storeCanvas(), this.storeHistory())
          : "quadratic_curve" === e.type
          ? 0 === e.iteration
          ...
          : "circle" === e.type
          ? (this.storeCanvas(), this.storeHistory())
          : "rectangle" === e.type
          ? (this.context.closePath(), this.storeCanvas(), this.storeHistory())
          : "eraser" === e.type && (this.storeCanvas(), this.storeHistory());
      },
      handleMouseLeave: function () {
        console.log("inject.js e 내부 handleMouseLeave");
        "eraser" === this.drawOptions[this.selectedDrawOption].type &&
          this.restoreCanvas();
      },
      ...
      drawEllipse: function (t, e, i, n) {
        console.log("inject.js e 내부 drawEllipse");
        var s = (i / 2) * 0.5522848,
          o = (n / 2) * 0.5522848,
          a = t + i,
          r = e + n,
        ...
        this.context.beginPath(),
          ...
          this.context.bezierCurveTo(t, c - o, h - s, e, h, e),
          this.context.bezierCurveTo(h + s, e, a, c - o, a, c),
          this.context.bezierCurveTo(a, c + o, h + s, r, h, r),
          this.context.bezierCurveTo(h - s, r, t, c + o, t, c),
          this.context.stroke();
      },
      ...
      triggerClick: function (t) {
        console.log("inject.js e 내부 triggerClick");
        this.triggerEvent(t, "click");
      },
      triggerEvent: function (t, e) {
        console.log("inject.js e 내부 triggerEvent");
        var i;
      ...
      initDragging: function () {
        ...
        this.panel.addEventListener("mousedown", this.handleDraggingStart),
          this.panel.addEventListener("touchstart", this.handleDraggingStart),
          v.document.addEventListener("mouseup", this.handleDragDone),
          v.document.addEventListener("touchend", this.handleDragDone);
      },
      handleDraggingStart: function (t) {
        ...
        (e.pos_x =
          ...
          (e.pos_y =
            ...
            (void 0 === t.clientY ? t.touches[0].clientY : t.clientY)),
          this.addEventListener("mousemove", e.handleDragging),
          this.addEventListener("touchmove", e.handleDragging);
      },
      ...
      handleDragDone: function (t) {
        ...
        e.panel.removeEventListener("mousemove", e.handleDragging),
      ...
      handlePostMessageResponse: function (t) {
        console.log("inject.js e 내부 handlePostMessageResponse");
        if (t.origin === v.location.origin) {
          var e = t.data;
          "get_pixel_color_response" === e.method
            ? this.setColor(e.response)
            : "get_data_response" === e.method && this.render(e.response);
        }
      },
      exit: function () {
        ...
        this.canvas.parentNode.removeChild(this.canvas),
          ...
          v.document.removeEventListener("keydown", this.keydownBinded),
          v.document.removeEventListener("keypress", this.keypressBinded),
          v.document.removeEventListener(
            "keydown",
            this.handleHotKeysDownBinded
          ),
          v.document.removeEventListener("mouseup", this.handleDragDone),
          v.removeEventListener("resize", this.resizeBinded),
          v.removeEventListener("scroll", this.resizeBinded),
          (this.canvas = null),
          (this.context = null),
          ...
          "undefined" != typeof unsafeWindow &&
            null !== unsafeWindow &&
            ((unsafeWindow.NOTEPAD_INIT = !1), (unsafeWindow.CTRL_HIDDEN = !1));
      },
      eraseAll: function () {
        console.log("inject.js e 내부 eraseAll");
        this.context.clearRect(0, 0, this.canvas.width, this.canvas.height),
          this.paragraph &&
            (this.paragraph.clearIntervals(), (this.paragraph = null)),
          this.storeCanvas(!0),
          this.storeHistory(),
          v.localStorage.removeItem(
            "WP_CRX_STORAGE_SNAPSHOT_" + v.location.pathname
          );
      },
      ...
      saveData: function () {
        console.log("inject.js e 내부 saveData");
        g.runtime.sendMessage({
          method: "save_data",
          config: this.config,
        });
        ...
        console.log("inject.js e 내부 init"),
          ...
          (this.resizeBinded = Function.prototype.bind.call(function () {
            this.resizeTimeoutID &&
              (this.resizeTimeoutID = v.clearTimeout(this.resizeTimeoutID)),
              (this.resizeTimeoutID = v.setTimeout(
