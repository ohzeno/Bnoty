...
let hasInput = false; // 텍스트 입력 여부
let size = "20px"; // 텍스트 사이즈
...
function createCanvas() {
  ...
  window.document.body.appendChild(button);
  button.style = `position: absolute; top: 30px; left: 150px; z-index: 2147483647;`;
  ...
  window.document.body.appendChild(button);
  button.style = `position: absolute; top: 30px; left: 220px; z-index: 2147483647;`;
  ...
  window.document.body.appendChild(button);
  button.style = `position: absolute; top: 30px; left: 290px; z-index: 2147483647;`;
  ...
  input.style = `position: absolute; top: 30px; left: 380px; z-index: 2147483647;`;
  ...
  if (canvas) {
    ...
    test.addEventListener("click", onMouseClick);
  }
