...
!(function (t, e) {
 ...
 var g =
   ...
   e = {
     ...
     handleMouseDown: function (t) { // 그리기 함수
       ...
       if (
         ...
         this.context.beginPath(),
           this.context.moveTo(
             ...
             this.lastMouseDownLoc.y + 16 // 펜 작동 
           );
       ...
       else if ("line" === e.type) this.storeCanvas(); // 선
       else if ("quadratic_curve" === e.type) { // 곡선
         if (0 === e.iteration)
           this.storeCanvas(),
             (e.initLoc = {
       ...
       } else if ("bezier_curve" === e.type) { // 곡선
         if (0 === e.iteration)
           this.storeCanvas(),
             (e.initLoc = {
               x: this.lastMouseDownLoc.x,
       ...
       else if ("circle" === e.type) this.storeCanvas(); // 원
       else if ("rectangle" === e.type) this.storeCanvas(); // 사각형
       else if ("eraser" === e.type) // 지우개
         this.restoreCanvas(),
           this.context.save(),
     ...
     handleMouseMove: function (t) { // 그리기
       t.preventDefault();
       var e = this.drawOptions[this.selectedDrawOption],
