...
window.CaptureAPI = (function() {
    ...
    function capture(data, screenshots, sendResponse, splitnotifier) {
        console.log("capture FUNTION // USE --> captureVisibleTab ( Fullcapture.js )" );
        // 캠처하는곳
    ...
    function updateScreenshot(t, n) {
        ...
        if ( 10 >= a ){
            global.runtime.sendMessage({
                ...
                e && e.success || window.setTimeout(Function.prototype.bind.call(updateScreenshot, Bnoty, t, n, ++a), 300);
            });
        }
    }
