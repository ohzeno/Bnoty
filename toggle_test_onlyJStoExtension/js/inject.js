!(function (t, e) {
  if ("undefined" != typeof unsafeWindow && null !== unsafeWindow) {
    if (unsafeWindow.CTRL_HIDDEN) {
      ...
      if (!unsafeWindow.NOTEPAD_INIT) {
        t.NOTEPAD = e(t);
        t.NOTEPAD.init();
      }
    }
  } else {
    if (!(void 0 !== t.NOTEPAD && null !== t.NOTEPAD)) {
      t.NOTEPAD = e(t);
    }
    if (t.NOTEPAD.controlPanelHidden) {
      // t.NOTEPAD.showControlPanel();
    } else {
      if (!t.NOTEPAD.initialized) {
        t.NOTEPAD.init();
      }
    }
  }
  ...
  t.prototype.add = function (t) {
    ...
    if (this.array.length > this.MAX_ITEMS) {
  ...
  e = {
    ...
    createControlPanel: function () {
      ...
      c.setAttribute("class", "NOTEPAD_controls_control_option prtBtn"),
        ...
        d.setAttribute("class", "NOTEPAD_controls_control_option eraseAllBtn"),
        d.setAttribute("title", "Erase all"),
        u.setAttribute("class", "NOTEPAD_controls_control_option hideCtrlBtn"),
        u.setAttribute(
          "title",
    ...
    handleMouseDown: function (t) {
      ...
      if (
        ...
        if (
          ...
          this.storeCanvas(),
          this.paragraph && this.paragraph.isPointInside(this.lastMouseDownLoc))
        )
    ...
    exit: function () {
      ...
      this.canvas.parentNode.removeChild(this.canvas),
        ...
        v.document.removeEventListener("keydown", this.handleHotKeysDownBinded),
