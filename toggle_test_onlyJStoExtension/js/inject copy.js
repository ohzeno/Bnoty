    ...
    e = {
      ...
      createCanvas: function () {
        ...
        var t = localStorage.getItem(
          "WP_CRX_STORAGE_SNAPSHOT_" + window_e.location.pathname
        );
        if (t) {
          var e = new Image();
      ...
      persistLocalStorage: function () {
        ...
        try {
          window_e.localStorage.setItem(
            "WP_CRX_STORAGE_SNAPSHOT_" + window_e.location.pathname,
            e
          );
        } catch (t) {
          try {
            window_e.localStorage.clear(),
              window_e.localStorage.setItem(
                "WP_CRX_STORAGE_SNAPSHOT_" + window_e.location.pathname,
                e
              );
      ...
      storeCanvas: function (t) {
        ...
        this.browser.isChrome
          ...
          t ||
            (this.persistTimer &&
              (this.persistTimer = window_e.clearInterval(this.persistTimer)),
            (this.persistTimer = window_e.setTimeout(
      ...
      handleResize: function (t) {
        ...
        console.log("inject.js e 내부 handleResize", window_e === window);
      ...
      onControlPanelClick: function (t, e) {
        ...
        if (this.selectedDrawOption !== t) {
          var i = window_e.document.querySelectorAll(
      ...
      handlePostMessageResponse: function (t) {
        ...
        if (t.origin === window_e.location.origin) {
          var e = t.data;
      ...
      exit: function () {
        ...
        this.canvas.parentNode.removeChild(this.canvas),
          ...
          window_e.document.removeEventListener("keydown", this.keydownBinded),
          window_e.document.removeEventListener(
            "keypress",
            this.keypressBinded
          ),
          window_e.document.removeEventListener(
          ...
          window_e.document.removeEventListener("mouseup", this.handleDragDone),
      ...
      eraseAll: function () {
        ...
        this.context.clearRect(0, 0, this.canvas.width, this.canvas.height),
          ...
          this.storeCanvas(!0),
          this.storeHistory(),
          window_e.localStorage.removeItem(
            "WP_CRX_STORAGE_SNAPSHOT_" + window_e.location.pathname
          );
      },
